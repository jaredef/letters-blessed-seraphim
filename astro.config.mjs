			...
			/* sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: '285 - More SAD attacks, no Seattle conference, cry of anguish', link: '/letter/285/' },
						{ label: '286 - SAD attacks, no Seattle conf., tollhouse not dogma', link: '/letter/286/' },
						{ label: '287 - Puhalo scandal, Dudko, Fr. N’s conference, heart in Orthodoxy', link: '/letter/287/' },
						{ label: '288 - Puhalo scandal, Dudko, Fr. N’s conference, heart in Orthodoxy', link: '/letter/288/' },
						{ label: '289 - Open letter from Fr. Herman on Fr. Dudko', link: '/letter/289/' },
						{ label: '290 - Dudko & positive Gospel, suffering, PA 1981 conference', link: '/letter/290/' },
						...
						{ label: '293 - Search for true Orthodoxy, Santa Cruz Russ, conference', link: '/letter/293/' },
						...
						{ label: '296 - Declines PA conference, no prayer for suffering Russians', link: '/letter/296/' },
						...
						{ label: '299 - No reply to Puhalo & Fr. N., Kalomiros at PA conference', link: '/letter/299/' },
				...
				},
				{
					...
					items: [
						...
						{ label: '314 - Party at PA conference, Tavrion, Pilgrimage success', link: '/letter/314/' },
