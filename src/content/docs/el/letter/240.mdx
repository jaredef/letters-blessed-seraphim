---
title: 'Western Saints, Blessed Augustine, Vita Patrum'
description: Letter from Blessed Seraphim to Mr. Graves.
og:
  image: /og/240.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 240</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Mr. Graves</div>
