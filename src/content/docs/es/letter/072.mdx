---
title: Protestar el tratamiento del Archimandrita Kyprian K.
description: Letter from Blessed Seraphim to Minister of the Interior, Greece.
og:
  image: /og/072.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 072</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Minister of the Interior, Greece</div>
