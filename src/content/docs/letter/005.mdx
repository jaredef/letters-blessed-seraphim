---
title: Bookstore proposal
description: Letter from Blessed Seraphim to Gleb Podmoshenksy.
og:
  image: /og/005.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 005</div>
