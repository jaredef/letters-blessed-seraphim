---
title: Printing on new press
description: Letter from Blessed Seraphim to Gleb Podmoshenksy.
og:
  image: /og/018.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 018</div>
...
Wait until you come this weekend before writing Vladika Vitaly. He sent us an outrageous bill and it must be corrected. I forget what else you were supposed to do, but it can wait until Saturday.
