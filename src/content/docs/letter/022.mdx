---
title: Communism, Against False Union, Vladika John’s reply
description: Letter from Blessed Seraphim to Fr. Panteleimon.
og:
  image: /og/022.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 022</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Panteleimon</div>

---

Dear Fr. in Christ Panteleimon,[^1]
...
[^1]: This letter is undated. It is surmised that this letter was written sometime before the repose of St. John Maximovitch; that is, prior to January 1966.
