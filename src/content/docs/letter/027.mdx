---
title: Fr. Plea to not support autocephaly
description: Letter from Blessed Seraphim to Bishop Theodosius.
og:
  image: /og/027.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 027</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Bishop Theodosius</div>
