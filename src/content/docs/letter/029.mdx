---
title: Thanks for icon of St. Theodosius
description: Letter from Blessed Seraphim to Bishop Theodosius.
og:
  image: /og/029.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 029</div>
