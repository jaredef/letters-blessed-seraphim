---
title: The Orthodox Word, living conditions, autocephaly, Schmemann
description: Letter from Blessed Seraphim to Fr. Photios.
og:
  image: /og/030.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 030</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Photios</div>
