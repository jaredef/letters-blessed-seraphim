---
title: Crisis year, Metropolia, Spruce Island, Blessed Herman
description: Letter from Blessed Seraphim to Neketas Savvas Palassis.
og:
  image: /og/031.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 031</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: </div>
