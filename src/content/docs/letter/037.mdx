---
title: Suspension, Iakovos/Athenagoras/Schmemann
description: Letter from Blessed Seraphim to Fr. Seraphim Bobich.
og:
  image: /og/037.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 037</div>
