---
title: Hindu texts, peace w/Youngs, display at Ft. Ross
description: Letter from Blessed Seraphim to Vladimir and Sylvia Anderson.
og:
  image: /og/042.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 042</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipients: Vladimir and Sylvia Anderson</div>
...
Dear in Christ, Vladimir and Sylvia,
