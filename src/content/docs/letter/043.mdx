---
title: Practice for children, confession, Uniates
description: Letter from Blessed Seraphim to Fr. Alexey (Craig) Young and Matushka Susan.
og:
  image: /og/043.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 043</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipients: Fr. Alexey (Craig) Young, Matushka Susan</div>
...
I hope I didn’t give you too much of a scare on “meditation.” Certainly there is nothing wrong with reading Scripture and reflecting on it. It would be even better to read also a commentary on the Scripture passages—such as that of St. John Chrysostom, which exists complete in English.
