---
title: Convert problems, Moscow Patriarchate
description: Letter from Blessed Seraphim to Dr. John Johnstone.
og:
  image: /og/044.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 044</div>
