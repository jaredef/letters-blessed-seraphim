---
title: Thanks for donation from St. Tikhon’s Society
description: Letter from Blessed Seraphim to Alex V. Cattell.
og:
  image: /og/047.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 047</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Mr. Alex V. Cattell</div>
