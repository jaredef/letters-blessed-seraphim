---
title: Canonization of Blessed Herman, living conditions
description: Letter from Blessed Seraphim to Michael Azkoul.
og:
  image: /og/048.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 048</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Michael Azkoul</div>
