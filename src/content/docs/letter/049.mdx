---
title: Service to Blessed Herman, anarchy, Hitler
description: Letter from Blessed Seraphim to Neketas Palassis.
og:
  image: /og/049.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 049</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Neketas Savvas Palassis</div>
...
[^1]: Here we have corrected a grammatical error in transcription from the corpus of 328: *à la* instead of the transcribed *la the Soviet Church*. This is not without precedent, as Blessed Seraphim uses this expression in letters [102.1](/letter/102-1) and [112](/letter/112).
