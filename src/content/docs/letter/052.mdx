---
title: Metropolia, ecumenism, betraying Orthodoxy
description: Letter from Blessed Seraphim to Daniel Olsen.
og:
  image: /og/052.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 052</div>
