---
title: Metropolia, St. Herman, autocephaly
description: Letter from Blessed Seraphim to Fr. Vladimir Bridievey.
og:
  image: /og/060.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 060</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Vladimir Bridievey</div>
