---
title: Athenagoras’ apostasy, true Orthodox publications
description: Letter from Blessed Seraphim to Madrid Mission.
og:
  image: /og/063.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 063</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Madrid Mission</div>
