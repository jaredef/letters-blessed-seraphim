---
title: Living conditions at Platina
description: Letter from Blessed Seraphim to Lev Puhalo & Vassili.
og:
  image: /og/064.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 064</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Lev Puhalo & Vassili</div>
...
Dear Brothers in Christ, Lev[^1] and Vassili,
