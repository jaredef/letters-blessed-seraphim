---
title: Tonsure, The Orthodox Word on St. Herman canonization
description: Letter from Blessed Seraphim to Daniel Olson.
og:
  image: /og/065.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 065</div>
