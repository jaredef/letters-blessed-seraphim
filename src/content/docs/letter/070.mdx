---
title: Basic rule for prayer & daily readings
description: Letter from Blessed Seraphim to Nina Kojevnikov.
og:
  image: /og/070.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 070</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Nina Kojevnikov</div>
