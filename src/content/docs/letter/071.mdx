---
title: Spark of Orthodoxy, refer Fr. Azkoul in St. Louis
description: Letter from Blessed Seraphim to Catherine.
og:
  image: /og/071.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 071</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Catherine</div>
