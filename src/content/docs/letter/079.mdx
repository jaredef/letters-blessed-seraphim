---
title: Translations, Orthodox Word, Moscow Patriarchate
description: Letter from Blessed Seraphim to John Dunlop.
og:
  image: /og/079.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 079</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Mr. John Dunlop</div>
