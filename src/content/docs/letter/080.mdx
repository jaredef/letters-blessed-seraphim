---
title: Name of St. Herman, not St. Germain
description: Letter from Blessed Seraphim to Fr. Innocent.
og:
  image: /og/080.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 080</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Innocent</div>
