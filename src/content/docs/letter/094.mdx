---
title: Stay in seminary
description: Letter from Blessed Seraphim to Dimitry.
og:
  image: /og/094.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 094</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Dimitry</div>
