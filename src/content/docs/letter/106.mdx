---
title: Celtic cause, millenium, calendar, Jordanville tragedy
description: Letter from Blessed Seraphim to Daniel Olsen.
og:
  image: /og/106.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 106</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Daniel Olsen</div>
