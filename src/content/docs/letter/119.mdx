---
title: Vladika John relics from Vladika Savva, Life of Blessed Paisius
description: Letter from Blessed Seraphim to Nina Seco.
og:
  image: /og/119.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 119</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Nina Seco</div>
