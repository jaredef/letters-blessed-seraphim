---
title: Should not have mailed Shroud, don’t argue now
description: Letter from Blessed Seraphim to Fr. Alexey Young.
og:
  image: /og/124.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 124</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Alexey Young</div>

---

Passion Tuesday, 1973[^1]
...
[^1]: This letter is dated to 11 April/24 April, 1973.
