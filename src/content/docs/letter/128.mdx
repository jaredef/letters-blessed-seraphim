---
title: Comfort after Maggie’s death, suffering through
description: Letter from Blessed Seraphim to Sylvia Anderson.
og:
  image: /og/128.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 128</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Sylvia Anderson</div>
