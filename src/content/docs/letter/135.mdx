---
title: Boston & Seattle vs. Vladika John on converts, ODT
description: Letter from Blessed Seraphim to Fr. Johnikios.
og:
  image: /og/135.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 135</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Johnikios</div>

---

Transfiguration of the Lord, 1973[^1]
...
[^1]: This letter is dated to 6 August/19 August, 1973.
