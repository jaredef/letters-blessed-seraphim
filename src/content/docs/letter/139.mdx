---
title: Fr. Ephraim's 3rd letter, patristic revival, academic theology
description: Letter from Blessed Seraphim to Fr. Alexey Young.
og:
  image: /og/139.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 139</div>
