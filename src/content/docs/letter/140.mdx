---
title: Don’t print Acquisition without Kontzevitch’s permission
description: Letter from Blessed Seraphim to Lev Puhalo.
og:
  image: /og/140.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 140</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Lev Puhalo</div>
