...
<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 144</div>
...
As to the climax to this section: Teilhard de Chardin as extremely symptomatic of the “spirit of the age”—a “religious” thinker has come into fashion, favored even by Julian Huxley and the Soviet Union! (I’ll send some material from Russia on Teilhard.) You might look at Lecomte DuNo;y also, since the Greek Archdiocese article mentions him together with T. de С.; I have a feeling it will be easier to find good quotes from him!
