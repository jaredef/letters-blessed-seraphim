---
title: Endure, peacemaking between Alexey and Boston
description: Letter from Blessed Seraphim to Nina Seco.
og:
  image: /og/146.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 146</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Nina Seco</div>

---

Monday, Feb. 19/March 4, 1974
