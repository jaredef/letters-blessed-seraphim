---
title: Spiritual counsel, get college degree first
description: Letter from Blessed Seraphim to Luke Walmsley.
og:
  image: /og/157.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 157</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Luke Walmsley</div>
