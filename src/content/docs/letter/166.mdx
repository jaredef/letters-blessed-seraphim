---
title: Elder, Sobor, translations, Paul Bartlett
description: Letter from Blessed Seraphim to Fr. Ephraim.
og:
  image: /og/166.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 166</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Ephraim</div>
