---
title: 'John Kraft, his mother’s trying to get rid of him'
description: Letter from Blessed Seraphim to Barbara Murray.
og:
  image: /og/169.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 169</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Barbara Murray</div>
