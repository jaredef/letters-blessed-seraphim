---
title: 'Monastery as reward, raising her boys = salvation'
description: Letter from Blessed Seraphim to Maria Kraft.
og:
  image: /og/173.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 173</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Maria Kraft</div>
