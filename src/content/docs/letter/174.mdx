---
title: 'Birth control, sexuality, John Kraft’s education'
description: Letter from Blessed Seraphim to Fr. Alexey Young.
og:
  image: /og/174.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 174</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Alexey Young</div>

---

Annunciation of the Theotokos, 1975[^1]
...
[^1]: This letter is dated to 25 March/7 April, 1975.