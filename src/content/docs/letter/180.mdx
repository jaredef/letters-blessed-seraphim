---
title: 'Fr. Panteleimon cut off Vladika Averky for serving with Bishop Petros'
description: Letter from Blessed Seraphim to Vladika Laurus.
og:
  image: /og/180.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 180</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Vladika Laurus</div>
