---
title: 'Advice: Leaving community means spiritual trouble'
description: Letter from Blessed Seraphim to Barbara McCarthy.
og:
  image: /og/181.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 181</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Barbara McCarthy</div>
