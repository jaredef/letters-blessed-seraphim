---
title: 'Fr. Panteleimon, converts, coming schism, attack on Blessed Augustine'
description: Letter from Blessed Seraphim to Fr. Valery Lukianov.
og:
  image: /og/191.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 191</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Valery Lukianov</div>
