---
title: 'Thomas, trust, coming visit'
description: Letter from Blessed Seraphim to Thomas.
og:
  image: /og/198.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 198</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Thomas</div>
