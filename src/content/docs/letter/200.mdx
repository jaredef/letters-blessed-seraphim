---
title: 'Novitiate, seminary, narrow path'
description: Letter from Blessed Seraphim to Macarios.
og:
  image: /og/200.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 200</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Macarios</div>
...
Dear Brother in Christ, Macarios[^1],
...
[^1]: It is believed, though uncertain, that the recipient is Macarios Schaefer.
