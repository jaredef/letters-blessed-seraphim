---
title: 'Fr. Dudko, priesthood, Life of St. Gregory of Tours'
description: Letter from Blessed Seraphim to Paul Bartlett.
og:
  image: /og/201.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 201</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Paul Bartlett</div>
