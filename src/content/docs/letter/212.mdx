---
title: 'Blessed Augustine vs. Patristic “experts”, love & piety'
description: Letter from Blessed Seraphim to Nicholas Eastman.
og:
  image: /og/212.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 212</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Nicholas Eastman</div>
...
Dear Brother in Christ, Nicholas,[^1]
...
[^1]: Some doubts remain as to the identity of the Nicholas here named as recipient.
