---
title: 'Rebaptism, zeal not according to knowledge, Fr. Panteleimon fashion'
description: Letter from Blessed Seraphim to Andrew Bond.
og:
  image: /og/216.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 216</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Andrew Bond</div>

---

Bright Saturday, 1976[^1]
