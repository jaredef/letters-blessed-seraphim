---
title: 'Right wing, helped create a monster, fragrance of Orthodoxy'
description: Letter from Blessed Seraphim to Fr. Alexey Young.
og:
  image: /og/220.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 220</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Alexey Young</div>

---

Third Day of Trinity, 1976[^1]
...
[^1]: This letter is dated to June 2/15, 1976.
