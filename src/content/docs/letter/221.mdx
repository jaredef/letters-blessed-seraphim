...
description: Letter from Blessed Seraphim to Makarios Schaefer.
og:
  image: /og/221.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 221</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Makarios Schaefer</div>
