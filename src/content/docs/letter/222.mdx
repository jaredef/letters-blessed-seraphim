---
title: 'Dark clouds ahead, asylum at Platina'
description: Letter from Blessed Seraphim to Met. + Hilarion of Blessed Memory (Igor Kapral).
og:
  image: /og/222.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 222</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Met. + Hilarion of Blessed Memory (Igor Kapral)</div>
...
[^1]: Metropolitan Hilarion of Blessed Memory (Igor Kapral), Russian Orthodox Church Outside of Russia.