---
title: 'Loophole in your heart, letter to Andrew Bond'
description: Letter from Blessed Seraphim to Fr. Alexis of Boston.
og:
  image: /og/224.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 224</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Alexis of Boston</div>
