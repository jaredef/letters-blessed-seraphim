...
description: Letter from Blessed Seraphim to Fr. Mark Wakingham.
og:
  image: /og/226.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 226</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Mark Wakingham</div>
