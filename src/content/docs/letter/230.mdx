---
title: 'Andrew Bond, moderate stand for true Orthodoxy, rebaptisms'
description: Letter from Blessed Seraphim to Fr. Alexey Young.
og:
  image: /og/230.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 230</div>
