---
title: "No formal declarations on breaking communion"
description: Letter from Blessed Seraphim to Fr. Panagiotes.
og:
  image: /og/234.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 234</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Panagiotes</div>
