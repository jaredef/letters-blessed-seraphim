---
title: 'Baptism, monasticism, obedience, come'
description: Letter from Blessed Seraphim to Seraphim.
og:
  image: /og/237.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 237</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Seraphim</div>
