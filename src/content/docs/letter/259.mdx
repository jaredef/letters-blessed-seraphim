...
description: Letter from Blessed Seraphim to Fr. Donald in Tennessee.
og:
  image: /og/259.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 259</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Donald in Tennessee</div>
