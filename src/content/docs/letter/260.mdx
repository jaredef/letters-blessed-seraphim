...
description: Letter from Blessed Seraphim to Rev. Gooderidge.
og:
  image: /og/260.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 260</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Rev. Roy Gooderidge</div>

---

Feb. 9/22, 1979

Dear Rev. Goodridge,[^1]
