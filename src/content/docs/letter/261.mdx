...
description: Letter from Blessed Seraphim to Timothy Shell.
og:
  image: /og/261.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 261</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Timothy Shell</div>
