---
title: 'Timothy & Anna, Moscow Patriarchate, OCA ecumenism/modernism'
description: Letter from Blessed Seraphim to Fr. Basil Rhodes.
og:
  image: /og/262.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 262</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Basil Rhodes</div>
