---
title: 'Lev Puhalo to speak against tollhouses, disrespects Orthodoxy'
description: Letter from Blessed Seraphim to Fr. Roman Lukianov.
og:
  image: /og/266.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 266</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Roman Lukianov</div>
