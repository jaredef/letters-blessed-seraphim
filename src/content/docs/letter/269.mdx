---
title: 'Fr. Herman in Greece with four letters from others, writing only on Sundays'
description: Letter from Blessed Seraphim to Barry.
og:
  image: /og/269.png
---
...
<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 269</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Barry</div>
