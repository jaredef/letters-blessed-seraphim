---
title: 'Vladika Vitaly, cold pretentious, not take seriously'
description: Letter from Blessed Seraphim to Fr. Yves Dubois.
og:
  image: /og/271.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 271</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Yves Dubois</div>
