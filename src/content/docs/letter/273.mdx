---
title: 'Puhalo contra tollhouses, Blessed Augustine, sad, no debate, SAD'
description: Letter from Blessed Seraphim to Mrs. Prokopchuk.
og:
  image: /og/273.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 273</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Mrs. Prokopchuk</div>
