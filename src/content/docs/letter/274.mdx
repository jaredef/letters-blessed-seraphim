---
title: 'Give up reacting to Fr. Panteleimon, Orthodoxy, of head not heart'
description: Letter from Blessed Seraphim to Fr. Akakios.
og:
  image: /og/274.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 274</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Akakios</div>
