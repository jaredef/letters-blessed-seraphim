---
title: 'Sympathy for sufferings = for salvation; Akakios'
description: Letter from Blessed Seraphim to Fr. Chrysostomos.
og:
  image: /og/275.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 275</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Chrysostomos</div>
