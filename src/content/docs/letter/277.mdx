---
title: 'Open letter, spiritual fakery, infallibility, Vladika Andrew'
description: Letter from Blessed Seraphim to Fr. Mamas.
og:
  image: /og/277.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 277</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Mamas</div>
