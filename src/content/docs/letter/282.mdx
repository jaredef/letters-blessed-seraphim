---
title: 'Fr. John Lewis changing jurisdictions'
description: Letter from Blessed Seraphim to Fr. Ambrose Pogodin.
og:
  image: /og/282.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 282</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Ambrose Pogodin</div>
