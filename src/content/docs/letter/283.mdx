---
title: 'Failed as spiritual father, not Christian or caring, pride'
description: Letter from Blessed Seraphim to John Hudanish.
og:
  image: /og/283.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 283</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: John Hudanish</div>
