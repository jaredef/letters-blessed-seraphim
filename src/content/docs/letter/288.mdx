---
title: 'Children’s page for Orthodox America, ODT'
description: Letter from Blessed Seraphim to Metropolitan Hilarion.
og:
  image: /og/288.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 288</div>
...
[^1]: Metropolitan Hilarion of blessed memory (Igor Kapral)
