---
title: 'Catacomb Church, Dudko, Blessed Augustine v. Fr. N, definitions'
description: Letter from Blessed Seraphim to Michael.
og:
  image: /og/294.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 294</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Michael</div>
