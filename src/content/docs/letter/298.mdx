---
title: 'Non-Orthodox Christians, Dudko, interfaith marriage'
description: Letter from Blessed Seraphim to Anna, a Catechumen.
og:
  image: /og/298.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 298</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Anna, a Catechumen</div>
