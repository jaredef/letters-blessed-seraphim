---
title: 'Greek schism, commemoration Dudko at Lit., SAD Append.'
description: Letter from Blessed Seraphim to Constantine.
og:
  image: /og/301.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 301</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Constantine</div>
