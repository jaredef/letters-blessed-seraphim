---
title: 'Jurisdictions, grace, can’t change OCA, UCSC talk'
description: Letter from Blessed Seraphim to Met. + Jonah Paffhausen.
og:
  image: /og/306.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 306</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Met. + Jonah Paffhausen (James Paffhausen)</div>
