---
title: 'Spiritual looking in mirror, Fr. P, monasticism'
description: Letter from Blessed Seraphim to Vanya Danz.
og:
  image: /og/308.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 308</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Vanya Danz</div>
...
[^1]: Vanya Danz, some question about the name of the recepient remains, i.e. John D’Anci.
