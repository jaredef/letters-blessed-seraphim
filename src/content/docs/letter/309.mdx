---
title: 'Can’t advise his manuscript, humbly confess Orthodoxy'
description: Letter from Blessed Seraphim to George.
og:
  image: /og/309.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 309</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: George</div>
