---
title: 'The Orthodox Word 96 Tavrion, Metropolitan Philaret, Moscow and grace'
description: Letter from Blessed Seraphim to Dr. Johnstone.
og:
  image: /og/311.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 311</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Dr. John Johnstone</div>
