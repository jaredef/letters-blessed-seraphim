---
title: 'The Orthodox Word 96, silent majority v. Boston sect, 200 at Pilgrimage'
description: Letter from Blessed Seraphim to Vladika Gregory.
og:
  image: /og/313.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 313</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Vladika Gregory</div>
