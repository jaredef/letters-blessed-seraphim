---
title: 'Party at PA conferance, Tavrion, Pilgrimage success'
description: Letter from Blessed Seraphim to Fr. Gregory.
og:
  image: /og/314.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 314</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Gregory</div>
