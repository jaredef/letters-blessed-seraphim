---
title: 'The Orthodox Word not controversial, Boston became pressure group'
description: Letter from Blessed Seraphim to Fr. Demetrios.
og:
  image: /og/318.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 318</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Demetrios</div>
