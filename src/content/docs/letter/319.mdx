---
title: 'Basil Voytan’s seminary classes at Platina'
description: Letter from Blessed Seraphim to Fr. Johnikios.
og:
  image: /og/319.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 319</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. Johnikios</div>
