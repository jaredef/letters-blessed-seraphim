---
title: 'The Orthodox Word 96, non-finality of Russian Church situation/grace'
description: Letter from Blessed Seraphim to Fr. George Macris.
og:
  image: /og/320.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 320</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Fr. George Macris</div>
