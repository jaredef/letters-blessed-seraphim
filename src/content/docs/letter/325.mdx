---
title: 'Seminary training, living conditions at Platina'
description: Letter from Blessed Seraphim to Vladimir.
og:
  image: /og/325.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 325</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Vladimir</div>
