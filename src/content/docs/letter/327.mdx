---
title: 'Preparing for seminary and future'
description: Letter from Blessed Seraphim to Brother Gleb.
og:
  image: /og/327.png
---

<div style={{textAlign:'right', fontFamily:'monospace'}}>Letter no. 327</div>
<div style={{textAlign:'left', fontFamily:'monospace'}}>Recipient: Brother Gleb</div>
